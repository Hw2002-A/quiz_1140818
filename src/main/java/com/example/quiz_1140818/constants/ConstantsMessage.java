...
public class ConstantsMessage {
	...
	/**
	 * final:將參數定義為常數(固定不變的數),常數必須是有預設值,參數的命名規則是全大寫 ,用底線串接不同的字<br>
	...
	public static final String QUIZ_DESCRIPTION_ERROR = "Quiz descrtption error!!";

	public static final String QUIZ_START_DATE_ERROR = "Quiz statdate error!!";

	public static final String QUIZ_END_DATE_ERROR = "Quiz enddate error!!";
	...
	public static final String OPTIONS_CODE_ERROR = "Options code error!!";
	
	public static final String OPTIONS_OPTIONS_NAME_ERROR = "Options optionsname error!!";
	...
	public static final String USER_INFO_CNNOT_NULL = "User info is null!!";
